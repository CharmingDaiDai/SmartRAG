...
import com.mtmn.smartdoc.model.client.impl.AbstractLLMClient;
...
/**
 * OpenAI 兼容格式 LLM客户端实现
 *
 * <p>使用 OpenAI 兼容格式接口，适用于所有支持 OpenAI API 格式的服务</p>
 * <p>适用场景:</p>
 * <ul>
 *   <li>第三方 OpenAI 兼容 API 服务</li>
 *   <li>自建的 OpenAI 代理服务</li>
 *   <li>其他实现了 OpenAI API 格式的服务</li>
 * </ul>
 *
 * <p>注意事项:</p>
 * <ul>
 *   <li>如需使用 OpenAI 官方 API，建议使用 OpenAIOfficialLLMClient</li>
...
public class OpenAILLMClient extends AbstractLLMClient {
    ...
    protected ChatModel buildChatModel() {
        log.info("构建OpenAI同步聊天模型: baseUrl={}, model={}",
    ...
    protected StreamingChatModel buildStreamingModel() {
        log.info("构建OpenAI流式聊天模型: baseUrl={}, model={}",
                providerConfig.getBaseUrl(), modelConfig.getName());
