...
- **后端**：Spring Boot 3.2.2，支持插件式 RAG 策略框架
...
本项目附带**硕士学位论文第四章**的完整内容和可视化图表：

- 📖 [论文全文](docs/Chapter_4_Thesis.md) - 完整的系统设计与实现说明
- 🗂️ [论文图表导航](docs/index.html) - 6 个可视化图表（HTML 格式）
  - 用户操作业务流程图
  - 系统分层架构设计
  - 9 大功能模块树
  - 12 步文档处理流程
  - 数据库 E-R 图
  - RAG 管道 8 环节执行过程
- 📄 [论文图表说明](docs/README.md) - 详细的文档和使用指南

> 所有图表均为 HTML 格式，支持浏览器打开和打印为 PDF
